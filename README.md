...
- **רכב** — אחד מ-3 מצבים (נבחר באשף הגדרה): שכירות חודשית קבועה / מימון-ליסינג חודשי / בבעלות (בלי תשלום). ברירת מחדל: לא מוגדר (0), עד שהנהג ממלא את האשף.
- **ביטוח** — עלות חודשית נפרדת (חובה/צד ג׳/מקיף), מתווספת לעלות הרכב היומית.
...
state = {
  settings: {
    ...
    ownershipType,     // '' | 'rent' | 'finance' | 'owned' — נקבע באשף
    insuranceType,     // '' | 'חובה' | 'צד ג׳' | 'מקיף'
